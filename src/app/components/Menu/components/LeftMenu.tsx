  ...
  return (
    <div>
        ...
        >
          <div className="px-6">
            <a
              className="flex-none uppercase font-semibold text-xl text-black focus:outline-none focus:opacity-80"
              href="#"
              aria-label="Brand"
            >
              Break Cheese
